...
@if(\Illuminate\Support\Facades\Cache::store('database')->has('user_valid_web_level_1') or \Illuminate\Support\Facades\Cache::store('database')->has('user_valid_web_level_0') )
...
<br>
@if(\Illuminate\Support\Facades\Cache::store('database')->has('user_valid_web_level_0') or \Illuminate\Support\Facades\Cache::store('database')->has('user_valid_web_level_1') )
